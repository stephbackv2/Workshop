...
def experiments(numTries=20, steps=200, numArms=50, numProposed=10, best_optimism=0.1, numLayers=1, width=10, true_a0=1, true_b0=40):
    bColors = ['m', 'y', 'c']
...
if __name__ == "__main__":
    experiments(30, 100, 50, 10, 1, 20)
    experiments(30, 100, 1000, 10, 0.05, 2, 15)
